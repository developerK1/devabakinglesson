...
const filterCater = elm => {
    ...
    if(elm.innerText === "Cheese Cakes"){
        toggleClass("cheesecakes");
    }
    if(elm.innerText === "Cup Cakes"){
        toggleClass("cupcakes");
    }
    if(elm.innerText === "Biscuits"){
        toggleClass("biscuits");
    }
    if(elm.innerText === "Cookies"){
        toggleClass("cookie");
